...
Projeto desenvolvido como **Projeto Integrador** — curso de Tecnologia, Faculdade [Nome da Instituição].

| Nome | Função |
|---|---|
| [Nome 1] | Desenvolvimento de IA / Visão Computacional |
| [Nome 2] | Hardware / Integração Embarcada |
| [Nome 3] | Dataset / Labeling |
| [Nome 4] | Documentação / Testes |
