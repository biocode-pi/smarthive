...
import { Row, Col, Card, Alert, Badge, Spinner, Button } from 'react-bootstrap';
        ...
        <Col lg={3} sm={6}>
          <div className="stat-card">
            <div className="stat-card-content">
              ...
              <Link to="/colmeias" className="btn btn-sm btn-link text-primary p-0">
        ...
        <Col lg={3} sm={6}>
          <div className="stat-card">
            <div className="stat-card-content">
              ...
              <Link to="/lista" className="btn btn-sm btn-link text-primary p-0">
                Ver Detalhes <i className="fas fa-arrow-right ms-1"></i>
              </Link>
            </div>
          </div>
        ...
        <Col lg={3} sm={6}>
          <div className="stat-card">
            <div className="stat-card-content">
              ...
              <Link to="/alertas" className="btn btn-sm btn-link text-primary p-0">
                Ver Detalhes <i className="fas fa-arrow-right ms-1"></i>
              </Link>
            </div>
          </div>
        ...
        <Col lg={3} sm={6}>
          <div className="stat-card">
            <div className="stat-card-content">
              ...
              <Link to="/apiarios" className="btn btn-sm btn-link text-primary p-0">
                Ver Detalhes <i className="fas fa-arrow-right ms-1"></i>
              </Link>
            </div>
          </div>
      ...
      <Row className="g-3">
        <Col lg={6} xl={7} className="mb-4">
          <Card className="shadow-sm border-0 h-100">
            ...
            <Card.Footer className="text-center bg-white">
              <Link to="/alertas" className="btn btn-sm btn-primary px-4 rounded-pill">
        ...
        <Col lg={6} xl={5} className="mb-4">
          <Card className="shadow-sm border-0 h-100">
            ...
            <Card.Footer className="text-center bg-white">
              <Link to="/lista" className="btn btn-sm btn-primary px-4 rounded-pill">
          ...
          <Card className="shadow-sm border-0 text-center">
            <Card.Body className="py-5">
              <div className="mb-4">
                ...
                <Link to="/grafico-dashboard" className="btn btn-primary px-4 py-2 rounded-pill">
