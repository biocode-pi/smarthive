    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-secondary/10 to-background p-4">
      <Card className="w-full max-w-md p-8">
        <div className="text-center mb-10">
          ...
          <p className="text-sm text-muted-foreground">Crie sua conta e comece hoje</p>
        </div>
        ...
        <div className="mt-10 text-center">
          ...
          <Link to="/login" className="mt-4 inline-block text-sm text-primary hover:text-primary/80 font-medium transition-colors">
            Fazer login →
          </Link>
        </div>
      </Card>
